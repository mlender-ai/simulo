...
JSON output schema:
{
  ...
  "strengths": ["string"],
  "thinkAloud": [
    {"screen": "Screen N", "persona": "Persona A (e.g. first-time user)", "thought": "First-person inner monologue"},
    {"screen": "Screen N", "persona": "Persona B (e.g. experienced user)", "thought": "First-person inner monologue"},
    {"screen": "Screen N", "persona": "Persona C (e.g. skeptical user)", "thought": "First-person inner monologue"}
  ],
  "issues": [{
    "screen": "Screen N",
    "screenIndex": 0,
...
JSON 키는 영문, 값은 한국어. 반드시 순수 JSON만 반환:
{
  ...
  "strengths": ["한국어"],
  "thinkAloud": [
    {"screen": "화면 N", "persona": "페르소나 A (예: 신규 유저)", "thought": "1인칭 구어체"},
    {"screen": "화면 N", "persona": "페르소나 B (예: 기존 유저)", "thought": "1인칭 구어체"},
    {"screen": "화면 N", "persona": "페르소나 C (예: 비숙련 유저)", "thought": "1인칭 구어체"}
  ],
  "issues": [{
    "screen": "화면 N",
    "screenIndex": 0,
  ...
  "products": [
    {
      ...
      "weaknesses": ["string"],
      "thinkAloud": [
        {"screen": "string", "persona": "Persona A (e.g. first-time user)", "thought": "first-person"},
        {"screen": "string", "persona": "Persona B (e.g. experienced user)", "thought": "first-person"}
      ],
      "issues": [{
        "screen": "string",
        "severity": "Critical" | "Medium" | "Low",
  ...
  "products": [
    {
      ...
      "weaknesses": ["한국어"],
      "thinkAloud": [
        {"screen": "화면명", "persona": "페르소나 A (예: 신규 유저)", "thought": "1인칭 한국어"},
        {"screen": "화면명", "persona": "페르소나 B (예: 기존 유저)", "thought": "1인칭 한국어"}
      ],
      "issues": [{
        "screen": "화면명",
        "severity": "Critical" | "Medium" | "Low",
