...
const translations = {
  ko: {
    ...
    storageSection: "스토리지",
    storageUsage: "사용량",
    storageAnalyses: "개 분석 저장됨",
    storageLocalStorage: "로컬 스토리지",
    storageImages: "이미지 (IndexedDB)",
    storageClearAll: "전체 삭제",
    storageClearOld: "오래된 분석 삭제",
    storageClearOldDays: "일 이전 분석 삭제",
    storageClearConfirm: "정말 모든 분석 데이터를 삭제하시겠습니까? 이 작업은 되돌릴 수 없습니다.",
    storageCleared: "개 분석 삭제됨",
    storageWarning: "스토리지 용량이 부족합니다. 오래된 분석을 삭제하거나 설정에서 스토리지를 관리해주세요.",
    storageWarningDismiss: "닫기",

    // Analysis mode
    analysisMode: "분석 방식",
    modeHypothesis: "가설 검증",
    modeHypothesisDesc: "특정 행동 가설을 검증합니다",
    modeUsability: "사용성 분석",
    modeUsabilityDesc: "가설 없이 화면을 평가합니다",
    analysisOptions: "분석 관점",
    ...
    visualComplexityLabel: "시각 복잡도",
    effortLabel: "노력",
    impactLabel: "임팩트",
    gradeLabel: "등급",
    modeBadgeHypothesis: "가설",
    modeBadgeUsability: "사용성",
    filterByMode: "분석 방식",
    filterModeAll: "전체 방식",
  ...
  en: {
    ...
    storageUsage: "Usage",
    storageAnalyses: " analyses stored",
    storageLocalStorage: "Local Storage",
    storageImages: "Images (IndexedDB)",
    storageClearAll: "Clear All",
    storageClearOld: "Clear Old Analyses",
    storageClearOldDays: " days — clear older",
    storageClearConfirm: "Are you sure you want to delete all analysis data? This cannot be undone.",
    storageCleared: " analyses deleted",
    storageWarning: "Storage is almost full. Delete old analyses or manage storage in Settings.",
    storageWarningDismiss: "Dismiss",

    // Analysis mode
    analysisMode: "Analysis Mode",
    modeHypothesis: "Hypothesis Verification",
    modeHypothesisDesc: "Validate a specific behavior hypothesis",
    modeUsability: "Usability Analysis",
    modeUsabilityDesc: "Evaluate screens without a hypothesis",
    analysisOptions: "Analysis Perspectives",
    optionUsability: "Overall usability",
    optionDesireAlignment: "Desire alignment",
    optionCompetitorComparison: "Competitor comparison",
    optionAccessibility: "Accessibility (40-50s)",
    targetUserOptional: "Target User (optional)",
    targetUserOptionalPlaceholder:
      "Optional. Defaults to YafitMove core target (40-50s Korean women).",

    // Usability report
    usabilityReportTitle: "Usability Analysis Result",
    tabQuickWins: "Quick Wins",
    ...
    visualComplexityLabel: "Visual complexity",
    effortLabel: "Effort",
    impactLabel: "Impact",
    gradeLabel: "Grade",
    modeBadgeHypothesis: "Hypothesis",
    modeBadgeUsability: "Usability",
    filterByMode: "Analysis Mode",
